...
DEFAULT_CONFIG_DIR = Path.home() / ".amplifier-workbench" / "configs"
...
class ConfigManager:
    ...
    Storage: ~/.amplifier-workbench/configs/{config_id}.json
    """
    ...
    def __init__(self, config_dir: Path | None = None):
        ...
        Args:
            config_dir: Directory for config storage (default: ~/.amplifier-workbench/configs)
        """
